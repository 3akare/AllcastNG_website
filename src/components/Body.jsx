  ...
  return (
    <main>
      <section className="container mx-auto p-8 py-12 mb-32">
        ...
        <section className="w-full flex flex-col items-center justify-center gap-12 text-center mb-32">
          ...
          <p className="max-w-2xl text-[var(--text-grey)]">
            Allcast is a web hosting platform offering high-performance, secure
            solutions. Its state-of-the-art infrastructure ensures optimal
            resource allocation and rapid data processing, allowing websites and
            applications to run seamlessly during peak traffic. Advanced
            security measures, including firewalls, vulnerability scanning, and
            robust backup systems, safeguard online ventures. Allcast's
            user-friendly control panel, comprehensive knowledgebase, and 24/7
            support from skilled professionals demonstrate its commitment to
            customer satisfaction. With a focus on performance, security, and
            user experience, Allcast redefines industry standards.
          </p>
        </section>
      ...
      <section className="w-full flex flex-col items-center justify-center gap-12 text-center bg-[var(--primary-grey)] p-8 py-12 mb-32">
        <img src="assets/images/pricing-icon.svg" alt="" className="size-20" />
        <h1 className="text-5xl">
        ...
        <p className="max-w-2xl">
          ...
          you're an individual, a small business, or a large enterprise, we have
          cost-effective solutions tailored to meet your specific requirements
          and budget. Experience top-notch web hosting services without breaking
          the bank, thanks to Allcast's commitment to delivering unbeatable
